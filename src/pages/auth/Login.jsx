...
export default function Login() {
  ...
  return (
    <div className="w-full">
      ...
      <a
        href={`${window.location.hostname === 'localhost' ? '' : (import.meta.env.VITE_API_URL || 'https://webbuffmxhbe.onrender.com')}/api/auth/google`}
        target="_top"
        className="w-full px-6 py-3 rounded-lg border border-[#2d2d44] text-[#a0a0b0] hover:text-white hover:border-[#6C63FF]/50 hover:bg-[#6C63FF]/5 font-medium transition-all flex items-center justify-center gap-2 no-underline"
      >
